                        ...
                        <div class="grid grid-row-3 gap-6">
                            <div class="grid grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <x-text-input id="jumlah" class="mt-1 w-full" type="number" name="jumlah" oninput="calculateTotal()"/>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="total_harga" class="mt-1 w-full" type="number" name="total_harga" readonly />
                                </div>
