                                                ...
                                                <div
                                                    ...
                                                    <div class="mt-3 sm:mt-0 sm:ml-3">
                                                        <a class="w-full flex items-center justify-center px-8 py-3 text-base leading-6 font-small rounded-md text-purple-700 dark:text-purple-700 bg-purple-100 hover:bg-purple-50 hover:text-purple-600 focus:ring ring-offset-2 ring-purple-100 focus:outline-none transition duration-150 ease-in-out md:py-2 md:text-lg md:px-5"
                                                            href="{{ route('parameter.khusus_create') }}">
                                                            Tambah Data
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="overflow-hidden ">
                                                    <table class="min-w-full rounded-xl">
                                                        ...
                                                        <tbody class="divide-y divide-gray-300 ">
                                                            @foreach ($ParamObatKhusus as $obatKhusus)
                                                                <!-- Modal -->
                                                                <div id="deleteModal{{ $obatKhusus->id_parameter_obat_khusus }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-modal-toggle="deleteModal{{ $obatKhusus->id_parameter_obat_khusus }}">
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong
                                                                                    class="text-red-500">{{ $obatKhusus->tipe_obat }}
                                                                                </strong>?
                                                                            </p>
                                                                            <div
                                                                                class="flex justify-center items-center space-x-4">
                                                                                <form
                                                                                    action="{{ route('parameter.khusus_destroy', $obatKhusus->id_parameter_obat_khusus) }}"
                                                                                    method="POST"
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        {{ $ParamObatKhusus->firstItem() + $loop->index }}
                                                                    </td>
                                                                    <td
                                                                        class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                                                        {{ $obatKhusus->tipe_obat }}</td>
                                                                    ...
                                                                    <td class=" p-5 ">
                                                                        <div class="flex items-center gap-1">
                                                                            <a class="p-2  rounded-full  group transition-all duration-500  flex item-center"
                                                                                href="{{ route('parameter.khusus-edit', $obatKhusus->id_parameter_obat_khusus) }}">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                id="deleteButton"
                                                                                data-modal-target="deleteModal{{ $obatKhusus->id_parameter_obat_khusus }}"
                                                                                data-modal-toggle="deleteModal{{ $obatKhusus->id_parameter_obat_khusus }}">
                                                                                <svg class="" width="20"
