<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Parameter / Tingkat Kadaluwarsa') }}
        </h2>
    </x-slot>
                                                ...
                                                <div class="overflow-hidden ">
                                                    <table class="min-w-full rounded-xl">
                                                        ...
                                                        <tbody class="divide-y divide-gray-300 ">
                                                            @foreach ($ParamKadaluwarsa as $kadaluwarsa)
                                                                <!-- Modal -->
                                                                <div id="deleteModal{{ $kadaluwarsa->id_parameter_kadaluwarsa }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-modal-toggle="deleteModal{{ $kadaluwarsa->id_parameter_kadaluwarsa }}">
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong
                                                                                    class="text-red-500">{{ $kadaluwarsa->tahun_kadaluwarsa }}
                                                                                    :
                                                                                    {{ $kadaluwarsa->keterangan }}</strong>?
                                                                            </p>
                                                                            <div
                                                                                class="flex justify-center items-center space-x-4">
                                                                                <form
                                                                                    action="{{ route('parameter.destroy', $kadaluwarsa->id_parameter_kadaluwarsa) }}"
                                                                                    method="POST"
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        {{ $ParamKadaluwarsa->firstItem() + $loop->index }}
                                                                    </td>
                                                                    <td
                                                                        class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                                                        {{ $kadaluwarsa->tahun_kadaluwarsa }}</td>

                                                                    <td
                                                                        class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                                        {{ $kadaluwarsa->keterangan }} </td>
                                                                    <td
                                                                        class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                                        {{ $kadaluwarsa->bobot }}</td>
                                                                    <td class=" p-5 ">
                                                                        <div class="flex items-center gap-1">
                                                                            <a class="p-2  rounded-full  group transition-all duration-500  flex item-center"
                                                                                href="{{ route('parameter.kadaluwarsa-edit', $kadaluwarsa->id_parameter_kadaluwarsa) }}">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                id="deleteButton"
                                                                                data-modal-target="deleteModal{{ $kadaluwarsa->id_parameter_kadaluwarsa }}"
                                                                                data-modal-toggle="deleteModal{{ $kadaluwarsa->id_parameter_kadaluwarsa }}">
                                                                                <svg class="" width="20"
