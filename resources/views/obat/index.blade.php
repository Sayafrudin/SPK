                                                    ...
                                                    <table class="min-w-full rounded-xl">
                                                        ...
                                                        <tbody class="divide-y divide-gray-300 ">
                                                            @foreach ($obats as $obat)
                                                                <!-- Modal -->
                                                                <div id="deleteModal{{ $obat->id_obat }}" tabindex="-1"
                                                                    aria-hidden="true"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-modal-toggle="deleteModal{{ $obat->id_obat }}">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <form
                                                                                    action="{{ route('obat.destroy', $obat->id_obat) }}"
                                                                                    method="POST"
                                                                    ...
                                                                    <td class=" p-5 ">
                                                                        <div class="flex items-center gap-1">
                                                                            <a class="p-2  rounded-full  group transition-all duration-500  flex item-center"
                                                                                href="{{ route('obat.edit', $obat->id_obat) }}">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                id="deleteButton"
                                                                                data-modal-target="deleteModal{{ $obat->id_obat }}"
                                                                                data-modal-toggle="deleteModal{{ $obat->id_obat }}">
                                                                                <svg class="" width="20"
