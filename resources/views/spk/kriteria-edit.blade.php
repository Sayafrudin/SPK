        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('spk.update', $kriterias->id_kriteria) }}" method="POST">
                        @csrf
                        @method('PUT') 
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <form class="max-w-sm mx-auto">
                                        ...
                                        <select name="tipe_kriteria" id="tipe_kriteria"
                                            ...
                                            <option value="Benefit" {{ $kriterias->tipe_kriteria == 'Benefit' ? 'selected' : '' }}>Benefit</option>
                                            <option value="Cost" {{ $kriterias->tipe_kriteria == 'Cost' ? 'selected' : '' }}>Cost</option>
                                        </select>
                                    </form>
                                </div>
                                ...
                                <div>
                                    ...
                                    <x-text-input id="bobot" class="block mt-1 w-full" type="text"
                                        name="bobot" value="{{ $kriterias->bobot }}"/>
                                </div>
                            </div>
