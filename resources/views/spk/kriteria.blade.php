                                                    ...
                                                    <table class="min-w-full rounded-xl">
                                                        ...
                                                        <tbody class="divide-y divide-gray-300 ">
                                                            @foreach ($kriterias as $kriteria)
                                                                <!-- Modal -->
                                                                <div id="deleteModal{{ $kriteria->id_kriteria }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                data-modal-toggle="deleteModal{{ $kriteria->id_kriteria }}">
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <strong
                                                                                    class="text-red-500">{{ $kriteria->kode_kriteria }}
                                                                                    :
                                                                                    {{ $kriteria->nama_kriteria }}</strong>?
                                                                            </p>
                                                                            <div
                                                                                class="flex justify-center items-center space-x-4">
                                                                                <form
                                                                                    action="{{ route('spk.destroy', $kriteria->id_kriteria) }}"
                                                                                    method="POST"
                                                                ...
                                                                <tr
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        {{ $kriterias->firstItem() + $loop->index }}
                                                                    </td>
                                                                    <td
                                                                        class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                                                    ...
                                                                    <td class=" p-5 ">
                                                                        <div class="flex items-center gap-1">
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                id="deleteButton"
                                                                                data-modal-target="deleteModal{{ $kriteria->id_kriteria }}"
                                                                                data-modal-toggle="deleteModal{{ $kriteria->id_kriteria }}">
                                                                                <svg class="" width="20"
